...
if(isset($_POST['Submit']))
{
 ...
 $useremail=$_SESSION['signin'];
 $newpassword=md5($_POST['newpassword']);
$sql=mysqli_query($con,"SELECT email,password FROM users where password='$oldpass' && email='$email'");
...
{
	echo "fail"; //$_SESSION['msg2']="Old Password not match !!";
}
}
?>
...
<body style="overflow: auto;">
  ...
  <a href="home.php"> <i class="fa fa-home" id="home"></i></a>
	...
	<?php echo $_SESSION['msg1'];?><?php echo  $_SESSION['msg1'];?></div>

	<div class="passbox">
		<center><h3>Change Password</h3></center>
		<div>
		<form method="POST" action="" align="center" onsubmit="return valid();">
